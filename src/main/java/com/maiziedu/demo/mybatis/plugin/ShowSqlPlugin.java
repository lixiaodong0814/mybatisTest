package com.maiziedu.demo.mybatis.plugin;
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if(invocation!=null && invocation.getArgs()!=null && invocation.getArgs().length > 0 ){
			if(invocation.getArgs()[0] instanceof PreparedStatement){
				JDBC4PreparedStatement st = (JDBC4PreparedStatement)invocation.getArgs()[0];				
				System.out.println("执行的SQL为:" + st.getPreparedSql());
			}
		}	
